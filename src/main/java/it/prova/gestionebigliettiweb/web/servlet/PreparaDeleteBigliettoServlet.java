...
/**
 * Servlet implementation class PreparaDeleteBigliettoServlet
 */
@WebServlet("/PreparaDeleteBigliettoServlet")
public class PreparaDeleteBigliettoServlet extends HttpServlet {
