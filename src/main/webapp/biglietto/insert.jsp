			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form method="post" action="ExecuteInsertBigliettoServlet" class="row g-3" novalidate="novalidate">
								...
								<c:set var="bigliettoInPagina" value = "${insert_biglietto_attr}"/>
								...
								<div class="col-md-6">
									...
									<input type="text" name="provenienza" id="provenienza" class="form-control" placeholder="Inserire la provenienza"  
										value="${bigliettoInPagina.provenienza != null? bigliettoInPagina.provenienza:''}" required>
								</div>
								...
								<div class="col-md-6">
									...
									<input type="text" name="destinazione" id="destinazione" class="form-control" placeholder="Inserire la destinazione"  
										value="${bigliettoInPagina.destinazione}" required>
								</div>
								...
								<div class="col-md-6">
									...
									value="${bigliettoInPagina.prezzo}" required>
								</div>
